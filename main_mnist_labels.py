...
discriminator = DCDiscriminator(used_layers=3, total_layers=3, image_shape=img_shape, conv_dimension=70, num_labels=10)
...
trainer.train("mnist_32x32_5", "training_runs/mnist_5", training_config, trainset, override_resume_options=False)#, resume_path="training_runs/mnist_5/checkpoints/mnist_32x32_5_4_model.pt")