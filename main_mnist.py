...
generator = DCGenerator(latent_dimension=128, used_layers=3, total_layers=3, image_shape=img_shape, conv_dimension=48)
discriminator = DCDiscriminator(used_layers=3, total_layers=3, image_shape=img_shape, conv_dimension=48)
...
trainer.train("mnist_32x32_2", "training_runs/mnist_2", training_config, trainset, override_resume_options=False)#, resume_path="training_runs/mnist_1/checkpoints/mnist_32x32_1_4_model.pt")