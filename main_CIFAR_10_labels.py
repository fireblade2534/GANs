...
trainer.train("cifar_32x32_4", "training_runs/cifar_4", training_config, trainset, override_resume_options=False, resume_path="training_runs/cifar_4/checkpoints/cifar_32x32_4_8_model.pt")