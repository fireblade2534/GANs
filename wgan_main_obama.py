...
generator = WGenerator(latent_dimension=128, used_layers=4, total_layers=6, image_shape=img_shape, conv_dimension=96)
discriminator = WDiscriminator(used_layers=4, total_layers=6, image_shape=img_shape, conv_dimension=96)
...
trainer.train("obama_32x32_1", "training_runs/obama_2", training_config, trainset, override_resume_options=False)#, resume_path="training_runs/stanford_dogs_4/checkpoints/stanford_dogs_64x64_4_72_model.pt")